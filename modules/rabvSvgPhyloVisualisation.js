...
function visualisePhyloAsSvg(document) {
	...
	glue.inMode("module/rabvPhyloUtility", function() {
	...
	glue.inMode("module/rabvTreeVisualiser", function() {
	...
	glue.inMode("module/rabvTreeVisualisationTransformer", function() {
	...
	glue.inMode("module/rabvTreeVisualisationLegendTransformer", function() {
